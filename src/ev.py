...
KEY_MSDOS = (0x01, 151)
KEY_COFFEE = (0x01, 152)
KEY_SCREENLOCK = (0x01, KEY_COFFEE)
KEY_ROTATE_DISPLAY = (0x01, 153)
KEY_DIRECTION = (0x01, KEY_ROTATE_DISPLAY)
...
KEY_BRIGHTNESS_ZERO = (0x01, KEY_BRIGHTNESS_AUTO)
KEY_DISPLAY_OFF = (0x01, 245)
KEY_WWAN = (0x01, 246)
KEY_WIMAX = (0x01, KEY_WWAN)
KEY_RFKILL = (0x01, 247)
...
KEY_BRIGHTNESS_TOGGLE = (0x01, KEY_DISPLAYTOGGLE)
...
KEY_MIN_INTERESTING = (0x01, KEY_MUTE)
KEY_MAX = (0x01, 0x2ff)
BTN_MISC = (0x01, 0x100)
BTN_0 = (0x01, 0x100)
BTN_1 = (0x01, 0x101)
